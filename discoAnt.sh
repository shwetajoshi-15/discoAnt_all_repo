...
then
	...
	samtools view -S -h -b $DISCOANT/$GENE/minimap2_metagene/clean_metagene/${base}_clean.sam | samtools sort - > $DISCOANT/$GENE/minimap2_metagene/clean_metagene/${base}_clean_sorted.bam
	samtools view -h -F 2308 $DISCOANT/$GENE/minimap2_metagene/clean_metagene/${base}_clean_sorted.bam | samtools sort - > $DISCOANT/$GENE/minimap2_metagene/clean_metagene/${base}_clean_pri_sorted.bam
	samtools index $DISCOANT/$GENE/minimap2_metagene/clean_metagene/${base}_clean_pri_sorted.bam
	done
	touch $DISCOANT/$GENE/minimap2_metagene/clean_metagene/"$GENE"_sorted_pri_align_clean.COMPLETED
else
...
then
        ...
        samtools view -S -h -b $DISCOANT/$GENE/minimap2_metagene_transcriptome/clean_metagene/${base}_clean.sam | samtools sort - > $DISCOANT/$GENE/minimap2_metagene_transcriptome/clean_metagene/${base}_clean_sorted.bam
        samtools view -h -F 2308 $DISCOANT/$GENE/minimap2_metagene_transcriptome/clean_metagene/${base}_clean_sorted.bam | samtools sort - > $DISCOANT/$GENE/minimap2_metagene_transcriptome/clean_metagene/${base}_clean_pri_sorted.bam
        samtools index $DISCOANT/$GENE/minimap2_metagene_transcriptome/clean_metagene/${base}_clean_pri_sorted.bam
        done
   	touch $DISCOANT/$GENE/minimap2_metagene_transcriptome/clean_metagene/"$GENE"_sorted_pri_align_clean.COMPLETED
else
...
then
	...
	-o $DISCOANT/$GENE/featurecounts/"$GENE"_clean_counts.txt $DISCOANT/$GENE/minimap2_metagene/clean_metagene/*_clean_pri_sorted.bam
